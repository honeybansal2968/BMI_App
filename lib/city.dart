...
class _ShoppingScreentate extends State<HomeScreen> {
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: <Widget>[
                                                                        Align(
                                                                            ...
                                                                            child: Text("${productdetails[iindex]["pname"]}", style: const TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold))),
                                                                        Align(
                                                                            alignment:
                                                                                Alignment.bottomLeft,
                                                                            child: Text("${productdetails[iindex]["pdes"]}", style: const TextStyle(color: Colors.white, fontSize: 8))),
                                                                        Row(
                                                                          children: [
                                                                            const SizedBox(
                                                                                height: 30,
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              child: Text(" ${productdetails[iindex]["view"].toString()}", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.white)),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                      ],
